...
<li class="grid"><a class="color2" href="#">   Acceuil </a> </li>
	...
	<li class="active grid"><a class="color8" href="contact.php"> Contact </a> </li>
...
$pub1C=new pubC();
$listePubs=$pub1C->recupererPub(2);
$listePubss=$pub1C->recupererPub(1);
                        ...
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    ...
                                    <a style="margin-top:20px;" href="#" class="btn karl-btn" data-animation="fadeInUp" data-delay="1s" data-duration="500ms">voir collection</a>
                                </div>
                            </div>
                        </div>
                    </div>
